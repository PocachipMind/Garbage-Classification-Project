...
'''
for i in range(2,8):
    globals()[str(i)+"0_"+str(i)+"9_M_train_list"], globals()[str(i)+"0_"+str(i)+"9_M_val_list"] = train_test_split(globals()["all_M_image_"+str(i)+"0_"+str(i)+"9_path"], test_size=0.2, random_state=7)
    globals()[str(i)+"0_"+str(i)+"9_F_train_list"], globals()[str(i)+"0_"+str(i)+"9_F_val_list"] = train_test_split(globals()["all_F_image_"+str(i)+"0_"+str(i)+"9_path"], test_size=0.2, random_state=7)
